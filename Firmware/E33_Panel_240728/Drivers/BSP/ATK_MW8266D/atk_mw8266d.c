...
{
//    atk_mw8266d_hw_init();                          /* ATK-MW8266D硬件初始化 */ //初始化复位口（由后，应该正确初始化了
//    atk_mw8266d_hw_reset();                         /* ATK-MW8266D硬件复位 */ //正常执行，电位有下拉复位
    ...
    if (atk_mw8266d_at_test() != ATK_MW8266D_EOK)   /* ATK-MW8266D AT指令测试 */  //发送10次“AT”等待求应答，每次超时不候 它发出了它该发的
    {
